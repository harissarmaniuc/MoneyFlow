        ...
        <Card>
          ...
          <CardContent>
            <form onSubmit={handleAdd} className="space-y-4">
              ...
              <div className="flex gap-2">
                <Button type="submit" className="bg-emerald-600 hover:bg-emerald-700" disabled={createContact.isPending}>
                  Add
                </Button>
      ...
      {upcoming.length > 0 && (
        <Card className="border-emerald-200 bg-emerald-50">
          ...
          <CardContent>
            <div className="space-y-2">
              {upcoming.map((c) => {
                const target = getNextBirthdayDate(c.birthday);
                  ...
                  <div key={c.id} className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-emerald-700">
                        {target.toLocaleDateString("en-US", { month: "long", day: "numeric" })}
                      </p>
                    </div>
      ...
      {isLoading ? (
        ...
        <div className="grid gap-3">
          {contacts.map((contact) => {
            const bday = getNextBirthdayDate(contact.birthday);
            return (
              <Card key={contact.id}>
